...
from ouro_search.retriever.e5_backend import E5RetrieverConfig, E5Wiki18Retriever

PROJECT_ROOT = Path(__file__).resolve().parents[4]
DEFAULT_WIKI18_DIR = PROJECT_ROOT / "main/datasets/wiki18"
...
def backend() -> E5Wiki18Retriever:
    data_dir = Path(os.environ.get("OURO_WIKI18_DIR", DEFAULT_WIKI18_DIR))
